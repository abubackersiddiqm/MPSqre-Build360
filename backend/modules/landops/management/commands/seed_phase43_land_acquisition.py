...
from modules.landops.application.services import seed_defaults
from modules.tenant.models import Company


class Command(BaseCommand):
    help = "Create generic Phase 43 land acquisition governance defaults."
    ...
    def handle(self, *args, **options):
        ...
        for company in companies.iterator():
            ...
            count += result["policy"]
        self.stdout.write(self.style.SUCCESS(f"Phase 43 land acquisition defaults reconciled. Created policies: {count}"))
