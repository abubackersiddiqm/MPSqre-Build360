...
CODES = [
    "insights.view", "insights.manage", "insights.objective", "insights.kpi", "insights.portfolio",
    "insights.benefit", "insights.action", "insights.board", "insights.approve", "insights.export",
]


class Command(BaseCommand):
    help = "Grant Phase 37 executive intelligence permissions to a tenant role."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Granted/reconciled {permissions.count()} permissions; {created} new assignments."))
