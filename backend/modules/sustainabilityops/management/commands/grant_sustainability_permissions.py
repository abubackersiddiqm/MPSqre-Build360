...
class Command(BaseCommand):
    help = "Grant Phase 38 sustainability, ESG and carbon permissions to a tenant role."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Granted/reconciled {permissions.count()} sustainability permissions; {created} new assignments."
            )
        )
