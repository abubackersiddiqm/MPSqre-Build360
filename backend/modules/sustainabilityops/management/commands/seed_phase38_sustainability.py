...
from modules.sustainabilityops.application.services import seed_defaults
from modules.tenant.models import Company


class Command(BaseCommand):
    help = "Seed or reconcile Phase 38 sustainability policy defaults."
    ...
    def handle(self, *args, **options):
        ...
        for company in companies.iterator():
            ...
            self.stdout.write(self.style.SUCCESS(f"Phase 38 defaults reconciled for {company.code}: {result}"))
